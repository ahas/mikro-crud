...
> {
    ...
    [CrudParamTypes.OPTIONS]?:
        | FindOptions<T_CrudEntity, P>
        | FindOneOptions<T_CrudEntity, P>;
}
...
> {
    ...
    constructor(
        ...
        this.data[CrudParamTypes.ENTITY] =
            this.data[CrudParamTypes.ENTITY] || null;
        this.data[CrudParamTypes.ENTITIES] =
            this.data[CrudParamTypes.ENTITIES] || [];
        this.data[CrudParamTypes.BODY] = this.data[CrudParamTypes.BODY] || null;
        this.data[CrudParamTypes.QUERY] =
            this.data[CrudParamTypes.QUERY] || ({} as any);
        this.data[CrudParamTypes.OPTIONS] =
            this.data[CrudParamTypes.OPTIONS] || ({} as any);
        this.data[CrudParamTypes.FILTER] =
            this.data[CrudParamTypes.FILTER] || ({} as any);
    ...
    async exec<T>(
        eventType: CrudHooks,
        defaultReturn: CrudParamTypes,
    ): Promise<T> {
        this.data[defaultReturn] = await this.call(
            eventType,
            this.data[defaultReturn],
        );
        ...
        if (defaultReturn === CrudParamTypes.ENTITY) {
            ...
            this.data[CrudParamTypes.ENTITY] =
                this.data[CrudParamTypes.ENTITIES][0];
        }
