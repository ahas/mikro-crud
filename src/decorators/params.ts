...
export const Query: () => ParameterDecorator = createCrudParamDecorator(
    CrudParamTypes.QUERY,
);
export const Filter: () => ParameterDecorator = createCrudParamDecorator(
    CrudParamTypes.FILTER,
);
export const Options: () => ParameterDecorator = createCrudParamDecorator(
    CrudParamTypes.OPTIONS,
);
export const Keys: () => ParameterDecorator = createCrudParamDecorator(
    CrudParamTypes.KEYS,
);
export const Body: () => ParameterDecorator = createCrudParamDecorator(
    CrudParamTypes.BODY,
);
