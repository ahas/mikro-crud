...
>(
    ...
    class CrudController
        implements ICrudController<T_CrudName, T_CrudEntity, P>
    {
        constructor(
    ...
    if (options.dto?.create) {
        ApiBody({ type: options.dto.create })(
    ...
    if (options.dto?.update) {
        ApiBody({ type: options.dto.update })(
            CrudController.prototype,
            "update",
            {
